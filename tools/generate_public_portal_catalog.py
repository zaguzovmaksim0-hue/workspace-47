    ...
    return [
        {
            ...
            "catalogStatus": "E2E_PENDING",
            "inventoryStatus": "VERIFIED_CONTRACT",
            "discoveryState": "REVIEWED",
            "evidenceIds": ["LIVE-JUNTA-OFVIRTUAL-2026-07-22"],
            "reviewedOn": "2026-07-22",
            "limitations": "Contrato estático implementado; aceptación E2E pendiente.",
        },
        {
