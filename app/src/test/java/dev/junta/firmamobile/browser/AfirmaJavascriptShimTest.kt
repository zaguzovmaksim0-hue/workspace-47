...
class AfirmaJavascriptShimTest {
    ...
    fun murciaCompatibilityPathIsProfileScopedToTheExactCmsAttachedSigningTuple() {
        ...
        assertTrue(murcia.contains("const murciaExtraProperties = \"filters=nonexpired:\\nmode=implicit\""))
        assertTrue(murcia.contains("args[3] === murciaExtraProperties"))
        assertTrue(murcia.contains("murciaExtraProperties.replace(/\\n/g, \"\\r\\n\")"))
