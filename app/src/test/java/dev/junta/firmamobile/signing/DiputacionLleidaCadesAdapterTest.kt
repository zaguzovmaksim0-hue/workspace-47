...
class DiputacionLleidaCadesAdapterTest {
    ...
    fun rejectsEveryContractMismatchAndEmptyOrInvalidPayload() = runTest {
        ...
        assertFailure(request(origin = "https://seu.diputaciolleida.cat.evil.example"), SigningErrorCode.UNSUPPORTED_PROTOCOL)
    ...
    private fun request(
        ...
        extraProperties: String = DiputacionLleidaCadesAdapter.EXPECTED_EXTRA_PROPERTIES,
        protocolId: SigningProtocolId = DiputacionLleidaCadesAdapter.ID,
        profileId: String = DiputacionLleidaCadesAdapter.PROFILE_ID,
        profileVersion: Int = DiputacionLleidaCadesAdapter.PROFILE_VERSION,
        origin: String = DiputacionLleidaCadesAdapter.INITIATOR_ORIGIN,
        ...
        algorithm = algorithm,
        format = format,
        safeDescription = DiputacionLleidaCadesAdapter.SAFE_DESCRIPTION,
