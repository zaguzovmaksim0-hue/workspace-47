...
class DiputacionLugoProfileCatalogBindingTest {
    ...
    fun `profile exposes only the exact reviewed browse surface`() {
        ...
        listOf(
            ...
            "https://user@sede.deputacionlugo.org",
            "https://sede.deputacionlugo.org.evil.example",
            "https://sede.deputacionlugo.org:8443",
            "https://deputacionlugo.org",
        ).forEach { rejected ->
    ...
    @Test
    fun `catalog binds Deputacion de Lugo without inventing signature capabilities`() {
        ...
        assertEquals("ES-PUB-0163", entry.inventoryId)
