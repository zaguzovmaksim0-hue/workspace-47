...
class CeutaProfileCatalogBindingTest {
    ...
    private val startUrl = URI("https://sede.ceuta.es/controlador/controlador?cmd=info&modulo=info")
    ...
    fun `profile exposes only the exact reviewed browse surface`() {
        ...
        listOf(
            "http://sede.ceuta.es/controlador/controlador?cmd=info&modulo=info",
            "https://user@sede.ceuta.es/controlador/controlador?cmd=info&modulo=info",
            "https://sede.ceuta.es.evil.example/controlador/controlador?cmd=info&modulo=info",
            "https://sede.ceuta.es:8443/controlador/controlador?cmd=info&modulo=info",
            "https://sede.ceuta.es/controlador/controlador?cmd=tramite&modulo=tramites&tramite=ANI",
            "https://sede.ceuta.es/controlador/controlador?cmd=requisitos&modulo=info",
        ).forEach { rejected ->
    ...
    @Test
    fun `catalog binds Ceuta without inventing signature capabilities`() {
