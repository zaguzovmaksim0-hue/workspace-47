...
class SiteProfileCatalogParserTest {
    ...
    fun releaseEnablesVerifiedProfilesWhileQaKeepsExperimentalPortalsAvailable() {
        ...
        val lugo = ProfileId("diputacion-lugo-sede")
        val malaga = ProfileId("diputacion-malaga-sede")
        val ourense = ProfileId("diputacion-ourense-sede")
        val palencia = ProfileId("diputacion-palencia-sede")
        val salamanca = ProfileId("diputacion-salamanca-sede")
        val segovia = ProfileId("diputacion-segovia-sede")
        val teruel = ProfileId("diputacion-teruel-sede")
        val zamora = ProfileId("diputacion-zamora-sede")
        val zaragoza = ProfileId("diputacion-zaragoza-sede")
        val aragon = ProfileId("aragon-siraw")
        val ofvirtual = ProfileId("junta-ofvirtual")
        val unizar = ProfileId("unizar-tramitador")
        val releaseProfiles = setOf(carne, education, ceuta, lugo, malaga, ourense, palencia, salamanca, segovia, teruel, zamora, zaragoza, aragon, ofvirtual, unizar)
        val qaOnly = setOf(
            junta,
        ...
        setOf(education, ceuta, lugo, malaga, ourense, palencia, salamanca, segovia, teruel, zamora, zaragoza).forEach { profileId ->
            assertEquals(
