...
/** Local detached CAdES adapter for Diputació de Lleida's exact certificate-login contract. */
class DiputacionLleidaCadesAdapter internal constructor(
    ...
    companion object {
        val ID = SigningProtocolId("diputacion-lleida-login-cades-v1")
        const val PROFILE_ID = "diputacion-lleida-sede"
        const val PROFILE_VERSION = 1
        const val INITIATOR_ORIGIN = "https://seu.diputaciolleida.cat"
        const val SAFE_DESCRIPTION = "Acceso con certificado a la Diputació de Lleida"
