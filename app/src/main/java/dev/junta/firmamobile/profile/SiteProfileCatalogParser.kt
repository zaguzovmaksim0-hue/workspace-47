                ...
                clientAuthPolicy?.transitionMode == ClientAuthTransitionMode.DIRECT_FROM_SOURCE &&
                    ...
                    (
                        p.profileId.value == SANIDAD_PROFILE_ID &&
                            ...
                            p.profileId.value == MENORCA_PROFILE_ID &&
                                clientAuthPolicy.fixedQueryParameters.isEmpty() &&
                                clientAuthPolicy.requiredEphemeralQueryParameters == setOf(MENORCA_URL_PARAMETER) &&
                                clientAuthPolicy.sourceRequiredEphemeralQueryParameters == setOf(MENORCA_URL_PARAMETER) &&
                                clientAuthPolicy.linkedEphemeralQueryParameters == setOf(MENORCA_URL_PARAMETER)
                    )
