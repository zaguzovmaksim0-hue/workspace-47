...
| Entradas `IMPLEMENTED_NOT_E2E` | 118 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 122 |
| Entradas restantes fuera de ambos estados | 61 |
