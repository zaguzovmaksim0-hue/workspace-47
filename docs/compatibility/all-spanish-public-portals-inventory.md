...
| Entradas `IMPLEMENTED_NOT_E2E` | 108 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 112 |
| Entradas restantes fuera de ambos estados | 71 |
