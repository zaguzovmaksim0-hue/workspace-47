...
| Fuentes oficiales portal-specific registradas | 226 |
| Fuentes oficiales totales registradas | 238 |
| Entradas `VERIFIED_E2E` | 4 |
| Entradas `IMPLEMENTED_NOT_E2E` | 55 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 59 |
| Entradas restantes fuera de ambos estados | 124 |
