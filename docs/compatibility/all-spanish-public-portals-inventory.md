...
| Entradas `IMPLEMENTED_NOT_E2E` | 144 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 148 |
| Entradas restantes fuera de ambos estados | 35 |
