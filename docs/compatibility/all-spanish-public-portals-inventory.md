...
| Entradas `IMPLEMENTED_NOT_E2E` | 29 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 33 |
| Entradas restantes fuera de ambos estados | 150 |
