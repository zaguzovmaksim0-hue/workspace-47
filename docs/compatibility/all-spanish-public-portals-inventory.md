...
records:
  ...
  - inventory_id: "ES-PUB-0051"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la raíz pública exacta de la Sede electrónica del Instituto de Contabilidad y Auditoría de Cuentas; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La raíz oficial https://icac.sede.gob.es/ respondió HTTP 200 en un GET HTTPS público y estable; no se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["D11", "ICAC-SEDE-NAV-2026-08-25"]
    reason: "Perfil QA-only limitado al launch exacto de la raíz pública; no expone certificado, firma, autenticación ni envío de formularios, y E2E sigue pendiente."
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de la raíz pública sin iniciar sesión, firmar, cargar documentos ni presentar."
  ...
  - inventory_id: "ES-PUB-0056"
    ...
    entry_url: "https://sede.ine.gob.es/es/index.htm"
    procedure_page: "https://sede.ine.gob.es/es/index.htm"
    certificate_required: "NO_VERIFICADO"
    signature_required: "NO_VERIFICADO"
    js_client: "NO_VERIFICADO"
    protocol_family: "AGE_PUBLIC_SEDE_NAVIGATION"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la entrada pública exacta /es/index.htm de la Sede electrónica del INE; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La página oficial https://sede.ine.gob.es/es/index.htm expone públicamente trámites de padrón, censo electoral, sanciones/pagos, becas y registro electrónico; no se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["D11", "INE-SEDE-NAV-2026-08-25"]
    reason: "Perfil QA-only limitado al launch exacto de /es/index.htm; no expone certificado, firma, autenticación ni envío de formularios, y E2E sigue pendiente."
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de /es/index.htm sin iniciar sesión, firmar, cargar documentos ni presentar."
    notes: "Ministerio(s) enumerador(es): Ministerio de Economía, Comercio y Empresa."
  ...
  - inventory_id: "ES-PUB-0057"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la raíz pública exacta de la Sede electrónica del Instituto para la Transición Justa; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La raíz oficial https://sede.transicionjusta.gob.es/ respondió HTTP 200 en un GET HTTPS público y estable; no se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["D11", "ITJ-SEDE-NAV-2026-08-25"]
    reason: "Perfil QA-only limitado al launch exacto de la raíz pública; no expone certificado, firma, autenticación ni envío de formularios, y E2E sigue pendiente."
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de la raíz pública sin iniciar sesión, firmar, cargar documentos ni presentar."
  ...
  - inventory_id: "ES-PUB-0086"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la raíz pública exacta de la Sede electrónica de Red.es; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La raíz oficial https://sede.red.gob.es/ respondió HTTP 200 en un GET HTTPS público y estable; no se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["D11", "RED-ES-SEDE-NAV-2026-08-25"]
    reason: "Perfil QA-only limitado al launch exacto de la raíz pública; no expone certificado, firma, autenticación ni envío de formularios, y E2E sigue pendiente."
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de la raíz pública sin iniciar sesión, firmar, cargar documentos ni presentar."
    notes: "Ministerio(s) enumerador(es): Ministerio para la Transformación Digital y de la Función Pública."
...
records:
  - inventory_id: "ES-PUB-0093"
    ...
    protocol_family: "VEA_CLIENT_TLS_AUTH"
    signature_format: "NO_VERIFICADO"
    signature_algorithm: "NO_VERIFICADO"
    endpoint: "https://ws235.juntadeandalucia.es/authenticationFacade"
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Acceso con certificado electrónico al PEG_VEA mediante el contrato público VEA → api-veaja → authenticationFacade; Workspace-47 implementa únicamente CLIENT_TLS_AUTH en QA y mantiene firma y presentación fuera de alcance."
    protocol_evidence: "El bundle público vigente inicia GET /auth/login con modoAcceso=afirma, codigoProcedimiento=PEG_VEA, comeBackUrl hacia /authFacade y redirectUrl Base64 acotado al PEG_VEA. El API responde 302 al gateway https://ws235.juntadeandalucia.es/authenticationFacade con action=validateCert, appId=CHIE.VEA, comeBackURL exacto a /auth/returnLogin y ticketId/webSessionId efímeros. La rama pública sin certificado retorna por /auth/returnLogin → /auth/endLogin → /authFacade?error&redirectUrl. La firma posterior no se infiere ni se habilita."
    client_tls_auth: "SI"
    evidence_ids: ["D03", "A01A", "A01B", "JUNTA-VEA-PEG-2026-08-17", "JUNTA-VEA-RUNTIME-2026-08-17", "JUNTA-VEA-CLIENT-AUTH-2026-08-28"]
    reason: "CLIENT_TLS_AUTH exacto implementado solo en QA con origin/path/query allowlist y challenge en el mismo WebView para conservar la sesión. SIGN, SELECT_CERTIFICATE, AFIRMA_URI, firma documental y presentación final permanecen bloqueados; falta E2E físico con certificado autorizado."
    reviewed_at: "2026-08-28"
    next_gate: "Validar físicamente el login CLIENT_TLS_AUTH en Android con certificado autorizado y detenerse antes de firma o presentación administrativa."
    notes: "api-veaja.cloud.juntadeandalucia.es no se confía por origin completo: solo /auth/login, /auth/returnLogin y /auth/endLogin con formas de query exactas. ws235 se autoriza únicamente desde el source VEA exacto y con appId=CHIE.VEA/callback VEA exactos."
  ...
  - inventory_id: "ES-PUB-0115"
    ...
    entry_url: "https://www.euskadi.eus/web01-sedeform/es/x43kToolkitWar/form/fdp?procedureId=1017701&tipoPresentacion=19&language=es"
    procedure_page: "https://www.euskadi.eus/registro/registro-electronico-general/web01-tramite/es/"
    certificate_required: "CONDICIONAL"
    signature_required: "SI"
    js_client: "NO_VERIFICADO"
    protocol_family: "CLIENT_TLS_AUTH"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Acceso con certificado al Registro Electrónico General 1017701 mediante Izenpe Client TLS; la firma documental y el envío final quedan fuera del contrato implementado."
    protocol_evidence: "El Giltza actual inicia OAuth en eidas.izenpe.com; la rama Certificados digitales produce un auto-POST con request y x_correlation_id hacia eidas2.izenpe.com/cert-authn-external-validation/authenticate, cuyo TLS solicita certificado cliente."
    client_tls_auth: "SI"
    evidence_ids: ["D03", "A18A", "A18B", "A18C", "EUSKADI-RGE-1017701-2026-08-19", "EUSKADI-IZENPE-CLIENTTLS-2026-08-19"]
    reason: "CLIENT_TLS_AUTH implementado solo en QA con página source, POST target, nombres de campos, host/path/port, CA no vacío y TTL acotados; sin E2E. No se infieren algoritmo, formato ni contrato de firma documental posterior."
    reviewed_at: "2026-08-19"
    next_gate: "E2E físico Android del acceso Izenpe con certificado hasta el retorno autenticado, deteniéndose antes de firma documental y envío final; verificar por separado el algoritmo/ABI Giltza antes de implementar SIGN."
...
records:
  ...
  - inventory_id: "ES-PUB-0124"
    ...
    procedure_page: "https://ovac.conselldeformentera.cat/ovac/catala/emiservicio/41E6BF9D755E4825AF8E6B49E85B5079.asp"
    certificate_required: "CONDICIONAL"
    signature_required: "CONDICIONAL"
    js_client: "NO_VERIFICADO"
    protocol_family: "ABSIS_OVAC_PUBLIC_NAVIGATION"
    signature_format: "NO_VERIFICADO"
    signature_algorithm: "NO_VERIFICADO"
    endpoint: "NO_VERIFICADO"
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only al catálogo público OVAC exacto, sin autenticación, firma ni presentación administrativa."
    protocol_evidence: "La raíz oficial https://ovac.conselldeformentera.cat/ respondió HTTP 200 y publicó un meta-refresh same-origin exacto a /ovac/catala/emiservicio/41E6BF9D755E4825AF8E6B49E85B5079.asp; la página resuelta respondió HTTP 200 y expuso el catálogo público OVAC. No se atribuye ABI de firma, algoritmo, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["I04B", "FORMENTERA-OVAC-2026-08-16"]
    reason: "Perfil QA-only limitado a la navegación pública exacta de la raíz OVAC y su destino meta-refresh same-origin; la firma, autenticación, client TLS y presentación final permanecen fuera del contrato, por lo que E2E sigue pendiente."
    reviewed_at: "2026-08-16"
    next_gate: "Validar físicamente el lanzamiento exacto de OVAC sin iniciar sesión, firmar, cargar documentos ni presentar una solicitud administrativa."
  ...
  - inventory_id: "ES-PUB-0126"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la entrada pública exacta de la Sede electrónica de El Hierro; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La entrada oficial https://elhierro.sedelectronica.es/info.0 respondió primero con un redirect same-origin que establece una cookie de sesión temporal; el siguiente GET HTTPS normal con esa sesión devolvió HTTP 200 en la misma URL. No se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["I05B", "ELHIERRO-SEDE-NAV-2026-08-25"]
    ...
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de la entrada de El Hierro con la sesión pública temporal, sin iniciar sesión, firmar, cargar documentos ni presentar."
    notes: "La existencia y titularidad proceden de la fuente oficial I05B; la comprobación técnica de navegación y del handshake temporal same-origin consta en ELHIERRO-SEDE-NAV-2026-08-25; no se realizó E2E."
  ...
  - inventory_id: "ES-PUB-0136"
    ...
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Navegación QA-only a la entrada pública exacta de la Sede electrónica de Lanzarote y su redirect origin oficial; autenticación, firma y presentación quedan fuera del contrato."
    protocol_evidence: "La entrada oficial https://cabildodelanzarote.sedelectronica.es/info.0 respondió HTTP 301 hacia https://lanzaroteylagraciosa.sedelectronica.es:443. En el origin vigente, el primer GET HTTPS normal estableció una cookie de sesión temporal mediante redirect same-origin y el siguiente GET con esa sesión devolvió HTTP 200 en la misma URL. No se infiere ABI de firma, autenticación, endpoint criptográfico ni client TLS."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["I10B", "LANZAROTE-SEDE-NAV-2026-08-25"]
    reason: "Perfil QA-only limitado a la entrada pública exacta y al redirect origin oficial con handshake same-origin de sesión; no expone certificado, firma, autenticación ni envío de formularios, y E2E sigue pendiente."
    reviewed_at: "2026-08-25"
    next_gate: "Validar físicamente el lanzamiento exacto de la entrada de Lanzarote, su redirect origin y la sesión pública temporal, sin iniciar sesión, firmar, cargar documentos ni presentar."
    notes: "La existencia y titularidad proceden de la fuente oficial I10B; la comprobación técnica del redirect y del handshake temporal same-origin consta en LANZAROTE-SEDE-NAV-2026-08-25; no se realizó E2E."
...
records:
  ...
  - inventory_id: "ES-PUB-0157"
    ...
    surface_name: "Sede electrónica de Diputación Foral de Gipuzkoa — Registro electrónico"
    surface_type: "SEDE"
    origin: "https://egoitza.gipuzkoa.eus"
    official_site: "https://egoitza.gipuzkoa.eus/es/"
    e_sede: "https://egoitza.gipuzkoa.eus"
    entry_url: "https://egoitza.gipuzkoa.eus/WAS/CORP/WATTramiteakWEB/inicio.do?idioma=C&app=00001"
    procedure_page: "https://egoitza.gipuzkoa.eus/es/registro/como-registrar"
    certificate_required: "SI"
    signature_required: "NO_VERIFICADO"
    js_client: "GILTZA_OAUTH_REDIRECT"
    protocol_family: "GILTZA_OAUTH_DELEGATED_CLIENT_TLS"
    signature_format: "NO_VERIFICADO"
    signature_algorithm: "NO_VERIFICADO"
    endpoint: "NO_VERIFICADO"
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Workspace-47 integra en QA únicamente el inicio público exacto del Registro electrónico de Gipuzkoa. La opción de certificado observada delega por Giltza/OAuth en Izenpe; la autenticación client-TLS posterior, la firma documental y la presentación final quedan fuera del contrato implementado."
    protocol_evidence: "La guía first-party vigente enlaza el Registro electrónico a WATTramiteakWEB con app=00001. Su HTML público ejecuta loginGiltza('Certificado') hacia loginCertificadoGiltzaCertificado.do, que responde 302 a eidas.izenpe.com/trustedx-authserver/izenpe/oauth con acr_values de flujo cert, client_id=izfe_giltza, response_type=code y callback first-party. El paso siguiente devuelve un formulario POST delegado a eidas2.izenpe.com/cert-authn-external-validation/authenticate; un handshake TLS 1.2 independiente contra ese origin emitió CertificateRequest. No se envió el POST delegado ni se presentó certificado."
    client_tls_auth: "SI"
    evidence_ids: ["D06", "DP19A", "DP19B", "GIPUZKOA-REGISTRO-2026-08-19", "GIPUZKOA-GILTZA-2026-08-19"]
    reason: "Perfil VERIFIED_CONTRACT/QA_ONLY limitado al launch público exacto del Registro y sin SIGN, SELECT_CERTIFICATE ni CLIENT_TLS_AUTH capabilities. Los origins eidas.izenpe.com y eidas2.izenpe.com permanecen fuera del trust del perfil: el mTLS real aparece tras un formulario POST con request opaco y no encaja de forma segura en el authorizer actual, orientado a contratos de navegación GET/top-level. Algoritmo, formato, packaging y callback de firma documental no se observaron. Falta E2E físico."
    reviewed_at: "2026-08-19"
    next_gate: "Validar físicamente la navegación QA al Registro. Para habilitar autenticación con certificado, implementar y probar un contrato fail-closed específico para la transición Izenpe de formulario POST hacia eidas2; después continuar autenticado solo hasta la frontera pre-firma, sin firmar ni presentar."
    notes: "Public/current pass: GET first-party, redirects OAuth estructurales y handshake TLS sin identidad. No se introdujeron credenciales, no se suministró certificado, no se envió el formulario POST delegado, no hubo carga, firma, pago ni presentación administrativa."
...
[LANZAROTE-SEDE-NAV-2026-08-25]: https://cabildodelanzarote.sedelectronica.es/info.0
