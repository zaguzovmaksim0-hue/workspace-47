...
records:
  - inventory_id: "ES-PUB-0093"
    ...
    e_sede: "https://veaja.cloud.juntadeandalucia.es/inicio/"
    entry_url: "https://veaja.cloud.juntadeandalucia.es/inicio/"
    procedure_page: "https://veaja.cloud.juntadeandalucia.es/inicio/"
    certificate_required: "CONDICIONAL"
    signature_required: "SI"
    js_client: "AUTOSCRIPT"
    protocol_family: "AUTOSCRIPT"
    signature_format: "CADES"
    signature_algorithm: "SHA256WITHRSA"
    endpoint: "NO_APLICA"
    discovery_state: "REVIEWED"
    inventory_status: "IMPLEMENTED_NOT_E2E"
    operation_summary: "Firma electrónica en la Ventanilla Electrónica (VEA) de la Junta de Andalucía."
    protocol_evidence: "La Ventanilla Electrónica (VEA) delega la firma a AutoScript.multiModeSign con hash precalculado SHA-256/SHA-512 sobre CAdES/XAdES."
    client_tls_auth: "NO_VERIFICADO"
    evidence_ids: ["D03", "A01A", "A01B"]
    reason: "Contrato multiModeSign prehashed verificado; pendiente validación E2E en producción."
    reviewed_at: "2026-08-15"
    next_gate: "Comprobación E2E con certificado en trámite administrativo real."
