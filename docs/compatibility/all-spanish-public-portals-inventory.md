...
records:
  ...
  - inventory_id: "ES-PUB-0002"
    ...
    reason: "Revalidación física 2026-08-26 confirma el client-TLS de Cl@ve eIdentifier y su POST exacto; el perfil sigue QA_ONLY/IMPLEMENTED_NOT_E2E hasta confirmar una sesión autenticada correcta y la aceptación XAdES de una actuación administrativa preparada por REG-AGE."
