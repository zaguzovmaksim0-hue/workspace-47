...
records:
  - inventory_id: "ES-PUB-0182"
    ...
    protocol_evidence: "La entrada oficial POSTea a claveEduPeticion.form; la pasarela genera ServiceProvider, el selector AFIRMA progresa por ServiceRedirect y entrega una forma POST exacta a pasarela-ident.clave.gob.es/IdP2/AuthenticateCitizen. El host TLS 1.2 emite CertificateRequest sin lista de CA; no se observó ABI de firma. El acceso CLIENT_TLS_AUTH fue aceptado E2E en un dispositivo físico el 2026-08-27 y la sesión regresó a la entrada de Educación."
    client_tls_auth: "VERIFIED_E2E"
    evidence_ids: ["LIVE-EDUCACION-ENTRY-2026-07-22", "EDUCACION-CONV46-CLIENTTLS-2026-08-19", "E2E-EDUCACION-CLIENTTLS-2026-08-27"]
    reason: "CLIENT_TLS_AUTH verificado E2E en dispositivo físico para la autenticación de la Convocatoria 46; la firma documental, formato, algoritmo, callback de firma y presentación final permanecen fuera de alcance."
    reviewed_at: "2026-08-27"
    next_gate: "Mantener bloqueadas la firma documental y la presentación final; cualquier ampliación requiere evidencia independiente y consentimiento para una operación distinta del login."
