...
| Entradas `IMPLEMENTED_NOT_E2E` | 136 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 140 |
| Entradas restantes fuera de ambos estados | 43 |
