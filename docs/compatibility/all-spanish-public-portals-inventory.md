...
| Entradas `IMPLEMENTED_NOT_E2E` | 146 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 150 |
| Entradas restantes fuera de ambos estados | 33 |
