...
| Entradas `IMPLEMENTED_NOT_E2E` | 165 |
| Entradas implementadas (`VERIFIED_E2E` + `IMPLEMENTED_NOT_E2E`) | 169 |
| Entradas restantes fuera de ambos estados | 14 |
