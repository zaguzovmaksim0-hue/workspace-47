# Red.es public sede navigation evidence — 2026-08-25

## Scope

This review covered only a public unauthenticated `GET` of the official Red.es
...
Workspace-47 adds the QA-only profile `red-es-sede-public-navigation` with the
exact root URL and exact origin `https://sede.red.gob.es`. The profile exposes
...
Primary source: <https://sede.red.gob.es/>.
