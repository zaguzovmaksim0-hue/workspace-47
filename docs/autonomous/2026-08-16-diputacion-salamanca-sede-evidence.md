# Sede electrónica de Diputación de Salamanca — Public BROWSE_ONLY Evidence — 2026-08-16
...
- Inventory: `ES-PUB-0168` / `diputacion-salamanca-sede`.
- Exact catalog seed: `https://sede.diputaciondesalamanca.gob.es`.
- 2026-08-16 bounded public check: strict TLS-verified GET returned HTTP 200 and stayed on the same official origin (public Sede page).
