# Sede electrónica de Diputación Provincial de Teruel — Public BROWSE_ONLY Evidence — 2026-08-16
...
- Inventory: `ES-PUB-0173` / `diputacion-teruel-sede`.
- Exact catalog seed: `https://dpteruel.sedelectronica.es`.
