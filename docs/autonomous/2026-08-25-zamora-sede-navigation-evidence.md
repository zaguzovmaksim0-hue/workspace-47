# Zamora public sede navigation evidence — 2026-08-25
...
- URL: `https://diputaciondezamora.sedelectronica.es/info.0`
...
The inventory retains the official documentary statement that some Zamora
...
Workspace-47 adds the QA-only profile `zamora-sede-public-navigation` with the
exact entry URL and origin `https://diputaciondezamora.sedelectronica.es`.
The profile allows only the observed public session-cookie handshake. It
...
Primary source: <https://diputaciondezamora.sedelectronica.es/info.0>.
