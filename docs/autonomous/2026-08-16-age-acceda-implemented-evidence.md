...
* `docs/compatibility/all-spanish-public-portals-inventory.md`: Registro `ES-PUB-0003` actualizado a `inventory_status: "IMPLEMENTED_NOT_E2E"`; en la integración actual las métricas quedan en `IMPLEMENTED_NOT_E2E: 160`, `VERIFIED_CONTRACT: 0` y 19 entradas fuera de los estados implementados.
