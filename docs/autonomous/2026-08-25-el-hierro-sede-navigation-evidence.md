# El Hierro public sede navigation evidence — 2026-08-25
...
- URL: `https://elhierro.sedelectronica.es/info.0`
...
Workspace-47 adds the QA-only profile `el-hierro-sede-public-navigation` with
the exact entry URL and origin `https://elhierro.sedelectronica.es`. The
profile allows ordinary same-origin browsing and the observed session-cookie
...
Primary source: <https://elhierro.sedelectronica.es/info.0>.
