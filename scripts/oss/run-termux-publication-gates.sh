...
step "6/6 — RECORD TERMUX-SAFE EVIDENCE; ANDROID REMAINS CLOUD-ONLY"
...
printf 'PASS: Termux-safe gates completed on %s\n' "$HEAD_SHA"
printf 'PENDING_CLOUD: Android Gradle/JVM/Kotlin gates were intentionally NOT run on the phone.\n'
